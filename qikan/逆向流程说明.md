...
| 文件 | 用途 |
|------|------|
| `fetch/fetch_page.py` | Python 入口，subprocess 调用 Node.js + requests 请求 |
| `fetch/sdenv_rs6.js` | Node.js sdenv 核心，jsdomFromUrl → Cookie 生成 |
...
| `prompt/task_cqvip_journal_guid.md` | 任务规格书（含 RS6 识别依据和分析路径） |
